...
const Home = () => {
  ...
  return (
    <div className="home-main-container">
      ...
      {/* 2. FAIXA AZUL */}
      <div style={{ backgroundColor: '#2196f3', color: '#fff', padding: '20px', textAlign: 'center', fontWeight: 'bold', fontSize: '1.2rem' }}>
        Suporte Técnico e Soluções Digitais com agilidade e confiança!
      </div>

      {/* 3. CARDS DE SERVIÇOS (Componente Services) */}
      <Services />

      {/* 4. SEÇÃO SOBRE */}
      <section style={{ background: '#f4f4f4', padding: '80px 20px', textAlign: 'center' }}>
        <h2 style={{ color: '#1a2b48', fontSize: '2.2rem', marginBottom: '20px' }}>Sobre a Informática Express</h2>
